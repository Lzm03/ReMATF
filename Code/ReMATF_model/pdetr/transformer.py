...
def build_transformer(args, num_feature_levels=1, two_stage=True, num_queries_one2one=300, num_queries_one2many=1500, mixed_selection= True, norm_type = 'pre_norm', decoder_type = 'global_ape', proposal_feature_levels = 4):
    return Transformer(
