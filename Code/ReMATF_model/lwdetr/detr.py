...
def lwdetr_build(args):
    ...
    args.dec_layers=3
    args.pretrain_exclude_keys=None
    args.group_detr=13
    args.dec_n_points=4
    args.two_stage = True
    ...
    args.use_varifocal_loss = True
    args.use_position_supervised_loss=True
